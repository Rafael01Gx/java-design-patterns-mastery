...
import com.rafaelmoraes.creational.abstractFactory.example02.concreteProducts.mac.*;
...
public class MacUIFactory implements UIFactory {
    ...
    public MacUIFactory(Theme theme) {
        this.theme = theme;
    }

    @Override
    public Button createButton(String label) {
        return new MacButton(label, theme);
    }
    ...
    public Checkbox createCheckbox(String label) {
        return new MacCheckbox(label, theme);
    }

    @Override
    public Dialog createDialog() {
        return new MacDialog(theme);
    }

    @Override
    public Menu createMenu() {
        return new MacMenu(theme);
    }
